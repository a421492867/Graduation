...
<script type="text/javascript" src="${ctx}js/modules/fault/reject.js"></script>
...
<body style="background:#e6e6e8">
	...
	<jqGrid:initGrid url="${basePath}reject/getData" colModel="${colModel}" colNames="${colNames}" extendFun="reform"></jqGrid:initGrid>
	</div>
