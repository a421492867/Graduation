...
<script type="text/javascript" src="${ctx}js/modules/fault/repair.js"></script>
...
<body style="background:#e6e6e8">
	...
	<jqGrid:initGrid url="${basePath}repair/getData" colModel="${colModel}" colNames="${colNames}" extendFun="reform"></jqGrid:initGrid>
	</div>
