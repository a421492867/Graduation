...
<script type="text/javascript" src="${ctx}js/modules/info/ofoInfo_add.js"></script>
<style type="text/css">
	.add-form{
	    padding: 20px;
	}
...
<body>
	...
	<div id="content" class="container">
		<form id="addInfo" class="form-horizontal add-form">
			<div class="form-group">
				<div class="input-group">
				<span class="input-group-addon">车辆编号</span>
				<input type="text" class="form-control" value="" onBlur="validate(this.value);" name="ofoCode">
			...
			<div class="form-group">
				...
				<input type="password" class="form-control" name="ofoPass">
				</div>
			</div>
