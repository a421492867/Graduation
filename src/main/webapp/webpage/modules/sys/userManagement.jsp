...
<% String colNames = "Id,用户名,用户昵称,角色,所在位置,操作"; 
String colModel = "{name:\"id\",width:80,resizable:false, sortable:false,hidden:true},{name:\"userName\", editable:false,width:80,resizable:false, sortable:false},{name:\"nickName\", editable:false,width:80 ,resizable:false, sortable:false},{name:\"roleId\", editable:false,width:80 ,resizable:false, sortable:false,formatter:roleFormat},{name:\"userLocation\", editable:false,width:80 ,resizable:false, sortable:false},{name:\"operation\", editable:false,width:80 ,resizable:false, sortable:false}";
...
<script type="text/javascript" src="${ctx}js/modules/sys/userManagement.js"></script>
...
<body style="background:#e6e6e8">
	...
	<!-- <h3>This Is For Baseinfo!</h3> -->
		<div id="searchBox" style="padding-top:20px; padding-left:20px">
			...
			<select id="role" style="height:34px">
	...
	<div id="operationBox" style="padding-top:14px; padding-left:20px">
	  ...
	  <jqGrid:deleteRow saveUrl="${basePath}userMgn/delete" name="删除" successFun="refreshGrid"></jqGrid:deleteRow>
	</div>
	<div id="widget-body" style="padding-top:14px;">
	<jqGrid:initGrid url="${basePath}userMgn/getData" colModel="${colModel}" colNames="${colNames}" extendFun="reform"></jqGrid:initGrid>
	</div>
