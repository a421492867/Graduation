package com.ofo.base.util.mail;
...
public class MailSendUtils {
	  ...
	  */    
		...
		public static boolean sendEmail(String SMTP, String PORT, String EMAIL,
				String PAW, String toEMAIL, String TITLE, String CONTENT, boolean validate,
				String TYPE) {
			...
			try {
				if ("1".equals(TYPE)) {
					return msu.sendTextMail(mailInfo);
				} else {
					return msu.sendHtmlMail(mailInfo);
				}
			} catch (Exception e) {
				return false;
			}
